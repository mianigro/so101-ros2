...
"""Autonomous VLA rollouts in Isaac Sim (the "generate" step).
...
Examples:
  self-improve/rollout_sim --config self-improve/configs/round_1.yaml \
      --rounds-root self-improve/rounds
  self-improve/rollout_sim --config self-improve/configs/round_1.yaml \
      --visualizer kit  # open the native Isaac Sim window
  self-improve/rollout_sim --eval --num-episodes 24  # metrics only
"""
