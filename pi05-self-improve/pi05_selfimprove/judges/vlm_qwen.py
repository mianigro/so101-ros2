...
The pi0.5 recipe needs a reward signal for autonomous rollouts; in the real
world there is no scripted oracle, so a small local VLM judges the final
overhead (+ wrist) frames against the task text.  Output is a strict-JSON
